...
## Generated on : Wed Dec 17 02:05:20 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Data_acquisition.elf
...
START_DIR                 = C:/YOUSSE~1/ASU/SENIOR~2/HYBRID~1/Project/HIL
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/youss/DOCUME~1/MATLAB/R2023a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Data_acquisition.elf
...
OBJS = MW_arduino_digitalio.o encoder_arduino.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o xcp_ext_mode.o Data_acquisition.o Data_acquisition_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Data_acquisition_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Data_acquisition_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Data_acquisition_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encoder_arduino.o : C:/Users/youss/Downloads/giampy1969-simulink-device-drivers-1.7.0.0/src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Data_acquisition.o : $(START_DIR)/Data_acquisition_ert_rtw/Data_acquisition.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Data_acquisition_data.o : $(START_DIR)/Data_acquisition_ert_rtw/Data_acquisition_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Data_acquisition_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Data_acquisition_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Data_acquisition_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Data_acquisition_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
